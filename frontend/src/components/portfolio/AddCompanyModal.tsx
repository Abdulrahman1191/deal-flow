    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
      <div className="bg-gray-900 border border-gray-700 rounded-2xl w-full max-w-2xl shadow-2xl flex flex-col max-h-[90vh]">
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-800">
          <p className="text-white font-semibold">Add portfolio company</p>
        ...
        <div className="flex-1 overflow-y-auto px-5 py-4 space-y-3">
          ...
          {mut.isError && (
            <p className="text-xs text-red-400">Failed — check your inputs.</p>
          )}
        </div>
        ...
        <div className="flex items-center justify-between px-5 py-4 border-t border-gray-800">
          ...
          <button
            ...
            className="px-5 py-2 text-sm rounded-lg bg-blue-600 hover:bg-blue-500 text-white disabled:opacity-50 disabled:cursor-not-allowed"
          >
